document.addEventListener('DOMContentLoaded', () => {
    ...
    const translations = {
        ...
        en: {
            ...
            "calc-highlight": "Zero cost for packaging and rust inhibitors.<br>Savings per 40FT container trip",
        ...
        jp: {
            ...
            "calc-highlight": "高価な梱包材・防錆費用ゼロ。<br>40FTコンテナ1回輸送時の節減効果",
            "row-total": "総節減額",
        ...
        cn: {
            ...
            "calc-highlight": "昂贵的包装及防锈成本为零。<br>每40FT集装箱运输次的节约效果",
            "row-total": "总节约金额",
